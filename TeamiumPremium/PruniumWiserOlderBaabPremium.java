 ...
 */
public class PruniumWiserOlderBaabPremium implements Player {

    final int maxDepth;

    public PruniumWiserOlderBaabPremium() {
        this(3);
    }

    public PruniumWiserOlderBaabPremium(int maxDepth) {
    ...
    public String getPlayName() {
        return "Prunium Wiser Older Baab Premium";
    }
