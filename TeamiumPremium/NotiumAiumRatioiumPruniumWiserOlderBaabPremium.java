 ...
 */
public class NotiumAiumRatioiumPruniumWiserOlderBaabPremium implements Player {

    final int maxDepth;

    public NotiumAiumRatioiumPruniumWiserOlderBaabPremium() {
        this(3);
    }

    public NotiumAiumRatioiumPruniumWiserOlderBaabPremium(int maxDepth) {
    ...
    public String getPlayName() {
        String name = "Notium Aium Ratioium Prunium Wiser Older Baab Premium";
